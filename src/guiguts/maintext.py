...
class SolarizedColors:
    ...
    BASE00 = "#657b83"      # DARK body
    BASE0 = "#839496"       # LIGHT body
    ...
    # Convenience aliases
    DARK_BACKGROUND = BASE03
    DARK_BACKGROUND_HIGHLIGHT = BASE02
    DARK_FOREGROUND_SECONDARY = BASE01
    DARK_FOREGROUND = BASE00
    LIGHT_BACKGROUND = BASE3
    LIGHT_BACKGROUND_HIGHLIGHT = BASE2
    LIGHT_FOREGROUND_SECONDARY = BASE1
    LIGHT_FOREGROUND = BASE0
...
class HighlightColors:
    ...
    CURSOR_LINE = {
        "Light": {"background": SolarizedColors.LIGHT_BACKGROUND_HIGHLIGHT,
                  "foreground": SolarizedColors.LIGHT_FOREGROUND},
        "Dark": {"background": SolarizedColors.DARK_BACKGROUND_HIGHLIGHT,
                 "foreground": SolarizedColors.DARK_FOREGROUND},
    }
    ...
    SEARCH = {
        "Light": {
            "background": SolarizedColors.LIGHT_BACKGROUND_HIGHLIGHT,
            "foreground": SolarizedColors.LIGHT_FOREGROUND,
            "relief": "ridge",
            "borderwidth": "2",
        },
        "Dark": {
            "background": SolarizedColors.DARK_BACKGROUND_HIGHLIGHT,
            "foreground": SolarizedColors.DARK_FOREGROUND,
            "relief": "ridge",
            "borderwidth": "2",
        },
    ...
    PROOFERCOMMENT = {
        "Light": {"background": SolarizedColors.LIGHT_BACKGROUND_HIGHLIGHT,
                  "foreground": SolarizedColors.RED},
        "Dark": {"background": SolarizedColors.DARK_BACKGROUND_HIGHLIGHT,
                 "foreground": SolarizedColors.RED},
    }

    HTML_TAG_BAD = {
        "Light": {"foreground": SolarizedColors.RED,
                  "background": SolarizedColors.LIGHT_BACKGROUND_HIGHLIGHT},
        "Dark": {"foreground": SolarizedColors.RED,
                 "background": SolarizedColors.DARK_BACKGROUND_HIGHLIGHT},
    }
    HTML_TAG_GOOD = {
        "Light": {"foreground": SolarizedColors.VIOLET},
        "Dark": {"foreground": SolarizedColors.VIOLET},
    }
    HTML_TAG_DIV = {
        "Light": {"foreground": SolarizedColors.GREEN},
        "Dark": {"foreground": SolarizedColors.GREEN},
    }
    HTML_TAG_SPAN = {
        "Light": {"foreground": SolarizedColors.BLUE},
        "Dark": {"foreground": SolarizedColors.BLUE},
    }
    HTML_TAG_P = {
        "Light": {"foreground": SolarizedColors.CYAN},
        "Dark": {"foreground": SolarizedColors.CYAN},
    }
    HTML_TAG_A = {
        "Light": {"foreground": SolarizedColors.YELLOW},
        "Dark": {"foreground": SolarizedColors.YELLOW},
    }
...
class MainText(tk.Text):
    ...
    def theme_set_tk_widget_colors(self, widget: tk.Text) -> None:
        ...
        """
        dark_bg = SolarizedColors.DARK_BACKGROUND
        dark_fg = SolarizedColors.DARK_FOREGROUND
        light_bg = SolarizedColors.LIGHT_BACKGROUND
        light_fg = SolarizedColors.LIGHT_FOREGROUND
    ...
    def highlight_configure_tags(self, first_run: bool = False) -> None:
        ...
        self._highlight_configure_tag("sel", {
            "Light": {"foreground":SolarizedColors.LIGHT_FOREGROUND,
                      "background": SolarizedColors.LIGHT_BACKGROUND_HIGHLIGHT },
            "Dark": {"foreground":SolarizedColors.DARK_FOREGROUND,
                      "background": SolarizedColors.DARK_BACKGROUND_HIGHLIGHT },
        })
